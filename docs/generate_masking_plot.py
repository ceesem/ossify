...
def main():
    ...
    with cell.skeleton.mask_context(cell.skeleton.labels['compartment'] == 2) as masked_cell:
        ...
        plt.savefig('docs/images/advanced_masking_axon.png', dpi=150, bbox_inches='tight')
        plt.close()
        ...
        strahler_vals = masked_cell.skeleton.get_label('strahler_number')
    ...
    with cell.skeleton.mask_context(cell.skeleton.labels['compartment'] == 3) as dendrite_cell:
        ...
        plt.savefig('docs/images/advanced_masking_dendrite.png', dpi=150, bbox_inches='tight')
        plt.close()
