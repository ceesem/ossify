...
from ossify.plot import plot_morphology_2d, plot_cell_multiview, single_panel_figure, add_scale_bar
...
def main():
    ...
    print(f"Available skeleton labels: {cell.skeleton.label_names}")
    ...
    # Map volume data
    if 'size_nm3' in cell.graph.label_names:
        volume = cell.graph.map_labels_to_layer("size_nm3", layer='skeleton', agg='sum')
        cell.skeleton.add_label(volume, 'volume')
